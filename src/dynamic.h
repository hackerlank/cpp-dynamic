...
private:
    ...
    union Data {
         ...
         */
        typedef std::aligned_storage<sizeof(std::unordered_map<int, int>),
            alignof(std::unordered_map<int, int>)>::type AlignedObjectStorage;
        AlignedObjectStorage objectBuffer;
    } u_;
};
